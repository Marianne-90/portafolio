  ...
  jobs: [
    {
      ...
      description: [
        ...
        "**Empoderando a los Clientes:** Proporcionar orientación técnica y capacitación integral para ayudar a los clientes a maximizar el valor de la plataforma LeanIX, profundizando en el modelo de datos, metamodelo, reportes, diagramas, paneles y diversas integraciones, así como asesorar sobre el uso efectivo de APIs y visualizaciones.",
        ...
        "**Planificación de Transformaciones:** Planificación y mapeo de iniciativas estratégicas y transformaciones, asegurando la alineación con sus objetivos empresariales y una ejecución eficiente.",
      ],
    },
    {
      year: "2021-2023",
      ...
      description: [
        ...
        "**Aseguré un registro de productos y mantenimiento de cuentas** en todas las plataformas, cumpliendo con las estrictas directrices de los marketplaces y manteniendo altas calificaciones de vendedor.",
    ...
    },
    {
      ...
      description: [
        ...
        "**Mantuve altas calificaciones en Google** al motivar constantemente a los agentes de las 15 tiendas.",
