...
export const DocumentoPDF = () => {
  const { home, education, skillsData, proyects, jobs, contact } = dataEs;
    ...
    >
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.greyContainer}>
          <Text style={styles.aboutMe}>Sobre mí</Text>
          <Text style={styles.aboutMeText}>{description}</Text>
        </View>

        <View style={styles.container}>
          <View style={styles.halfContainer}>
            <Text style={styles.mainSubTitle}>Educación</Text>
          ...
          >
            <Text style={styles.mainSubTitle}>Idiomas</Text>
